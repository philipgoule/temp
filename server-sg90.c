		...
		for(i=0;i<=maxi;i++)
		{
			...
			if((z = read(sockfd,buf,sizeof buf)) >0)
			{
				...
				if(buf[1] ==0x31)
				{
	     			    switch(buf[2])
		         	    {
				    case 0x31:/*MOTOR_GO_FORWARD*/system("./sg90 1 90&"); printf("servo 1:90\n");break;
				    case 0x32:system("./sg90 2 90&");printf("servo 2:90\n");break;         //MOTOR_GO_BACK;    printf("back\n");break;            						
				    case 0x33:system("./sg90 3 90&");printf("servo 3:90\n");break;//MOTOR_GO_LEFT;    printf("left\n");break;
				    case 0x34:system("./sg90 4 90&");printf("servo 4:90\n");break;;//MOTOR_GO_RIGHT;   printf("right\n");break;
				    case 0x35:system("./sg90 5 90&");printf("servo 5:90\n");break; //MOTOR_GO_STOP;    printf("stop\n");break;
					default: break;
				    }
				    digitalWrite(3, HIGH);
				}
